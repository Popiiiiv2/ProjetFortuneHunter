...
/*public class TestAction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        action.actionCarte(score1, carte);
        carte = paquetBrocante.tirerRandomCarte();
        action.actionCarte(score2, carte);
        carte = paquetBrocante.tirerRandomCarte();
        action.actionCarte(score2, carte);
        action.vente(score2);
...
/*        
        ...
        Debug.Log(carte.getValeur());
        action.modifierArgent(score1, carte);
        action.transfertArgentJoueur(score1, score2, 300);

        carte = paquetEvenement.tirerRandomCarte();
        Debug.Log(carte.getAction());
        Debug.Log(carte.getValeur());
        action.modifierArgent(score2, carte);
        action.transfertArgentJoueur(score2, score1, 100);

        action.transfertArgentCagnotte(score2, cagnotte, 50);
        action.transfertArgentCagnotte(score1, cagnotte, 100);
        action.gagnerCagnotte(score1, cagnotte);
*/

    /*ebug.Log(score1.ToString());
